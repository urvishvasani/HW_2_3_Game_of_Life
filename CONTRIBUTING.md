...
The following is a set of guidelines for contributing to CSC-510-HW1 and its packages, which are hosted in the [CSC-510-HW1](https://github.com/kenil-shah/CSC-510-HW1) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
- Maintain CSC-510-HW1's quality
- Fix problems that are important to users
- Engage the community in working toward the best possible CSC-510-HW1
- Enable a sustainable system for CSC-510-HW1's maintainers to review contributions
